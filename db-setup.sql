...
INSERT INTO nonconformances (ncId, scheduleId, type, severity, section, subsection, question, response, auditorComment, details, ncDetails, AIN, division, sector, qma, other, files) VALUES
...
(12, 9187, 'PEQ', NULL, NULL, NULL, 'Are supplier cybersecurity assessments current and comprehensive?', 'Cybersecurity assessments of critical suppliers are documented. However, periodic reassessments are not consistently performed per the 12-month requirement.', '12 of 45 critical suppliers have not been reassessed in over 24 months. This is a gap in the supplier risk management process.', 'Initial cybersecurity assessments completed for all critical suppliers. Reassessment tracking not automated.', 'Cyber supply chain risks may not be adequately monitored. Supplier security posture can degrade over time without reassessment.', 'AIN-2026-005', '[]', '[]', '[1]', '[]', '[116,117,118]');
